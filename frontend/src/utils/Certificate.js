export const generateCertificateHTML = (order) => {
...
export const openCertificate = (order) => {
  const html        = generateCertificateHTML(order);
  const printWindow = window.open('', '_blank');
  if (!printWindow) { alert('Please allow popups to download your certificate.'); return; }
